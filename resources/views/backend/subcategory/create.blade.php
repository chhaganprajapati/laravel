          ...
          <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('store.subcategory') }}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" name="subcategory_en" class="form-control" placeholder="SubCategory English">
              ...
              <div class="form-group">
                ...
                <input type="text" name="subcategory_hin" class="form-control" placeholder="SubCategory Hindi">
