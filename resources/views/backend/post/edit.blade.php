                ...
                <form class="forms-sample" action="{{ route('update.post',$post->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="category_id" id="exampleSelectGender">
                                ...
                                @foreach ($category as $row)
                                    <option value="{{$row->id}}" <?php if($row->id == $post->category_id){ echo 'selected';}?> >{{ $row->category_en }} - {{ $row->category_hin }}</option>
                                @endforeach
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="subcategory_id" id="subcategory_id">
                                ...
                                @foreach ($sub as $row)
                                    <option value="{{$row->id}}" <?php if($row->id == $post->subcategory_id){ echo 'selected';}?> >{{ $row->subcategory_en }} - {{ $row->subcategory_hin }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="district_id" id="exampleSelectGender">
                                ...
                                @foreach ($district as $row)
                                    <option value="{{$row->id}}" <?php if($row->id == $post->district_id){ echo 'selected';}?> >{{ $row->district_en }} - {{ $row->district_hin }}</option>
                                @endforeach
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="subdistrict_id" id="subdistrict_id">
                                ...
                                @foreach ($subdistrict as $row)
                                    <option value="{{$row->id}}" <?php if($row->id == $post->subdistrict_id){ echo 'selected';}?> >{{ $row->subdistrict_en }} - {{ $row->subdistrict_hin }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="tags_en" class="form-control" id="exampleInputName1" value="{{$post->tags_en }}">
                        </div>

                        <div class="form-group col-md-6">
                            <label for="exampleInputName1">Tags Hindi</label>
                            <input type="text" name="tags_hin" class="form-control" id="exampleInputName1" value="{{$post->tags_hin }}">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <label class="form-check-label col-md-3">
                            <input type="checkbox" name="bigthumbnail" class="form-check-input" value="1" <?php if($post->bigthumbnail == 1){ echo 'checked'; } ?>> General Gig Thumbnail <i class="input-helper"></i>
                        </label>

                        <label class="form-check-label col-md-3">
                            <input type="checkbox" name="first_section" class="form-check-input" value="1" <?php if($post->first_section == 1){ echo 'checked'; } ?>> First Section <i class="input-helper"></i>
                        </label>

                        <label class="form-check-label col-md-3">
                            <input type="checkbox" name="first_section_thumbnail" class="form-check-input" value="1" <?php if($post->first_section_thumbnail == 1){ echo 'checked'; } ?>> First Section BigThumbnail <i class="input-helper"></i>
                        </label>
