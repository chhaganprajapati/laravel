    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('update.subdistrict',$subdistrict->id) }}" method="POST">
                @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" name="subdistrict_hin" class="form-control" value="{{ $subdistrict->subdistrict_hin }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="exampleFormControlSelect2" name="district_id">
                        ...
                        @foreach ($district as $row)
                            <option value="{{ $row->id }}" <?php if($row->id == $subdistrict->district_id) echo 'selected'; ?> >{{$row->district_en}} | {{$row->district_hin}}</option>
                        @endforeach
