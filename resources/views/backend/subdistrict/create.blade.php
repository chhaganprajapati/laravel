          ...
          <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('store.subdistrict') }}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" name="subdistrict_en" class="form-control" placeholder="SubDistrict English">
              ...
              <div class="form-group">
                ...
                <input type="text" name="subdistrict_hin" class="form-control" placeholder="SubDistrict Hindi">
