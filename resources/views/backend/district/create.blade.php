          ...
          <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('store.district') }}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" name="district_en" class="form-control" placeholder="District English">
                @error('district_en')
              ...
              <div class="form-group">
                ...
                <input type="text" name="district_hin" class="form-control" placeholder="District Hindi">
                @error('district_hin')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
              </div>
