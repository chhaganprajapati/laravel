          ...
          <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('update.district',$district->id) }}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" name="district_en" class="form-control" value="{{ $district->district_en }}">
                @error('district_en')
              ...
              <div class="form-group">
                ...
                <input type="text" name="district_hin" class="form-control" value="{{ $district->district_hin }}">
                @error('district_hin')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
              </div>
