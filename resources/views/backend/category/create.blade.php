          ...
          <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('store.category') }}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" name="category_en" class="form-control" placeholder="Category English">
                @error('category_en')
              ...
              <div class="form-group">
                ...
                <input type="text" name="category_hin" class="form-control" placeholder="Category Hindi">
                @error('category_hin')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
              </div>
